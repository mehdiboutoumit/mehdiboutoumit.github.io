$(window).load(() => {
  ...
  // Add intersection observer to education section
const educationSection = document.querySelector('.education');
const educationSchools = document.querySelectorAll('.education-school');
const options = {
  threshold: 0.2
};
...
// Add delay to education schools
educationSchools.forEach((school, index) => {
  school.style.transitionDelay = `${index * 0.1}s`;
});
